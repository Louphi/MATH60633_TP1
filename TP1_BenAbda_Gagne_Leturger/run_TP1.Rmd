...
## Description 
L’objectif est d’estimer et de backtester la valeur en risque (VaR) d’un portefeuille de deux indices en utilisant le modèle GARCH(1,1)-Normal. 
Le code fourni dans les fichiers ne fonctionne pas. Vous devez le corriger et le compléter. 
Vous devez créer une structure de projet appropriée avec un script principal pour exécuter le code. 
Cela doit être indépendant de la plateforme. Tout doit être généré automatiquement.
...
knitr::include_graphics("Output/combined_plots.png")
